...
import { createInsurance } from '../../service/insuranceservice';
...
export const NewInsuranceForm = () => {
  ...
  useEffect(() => {
    if (formData.insuranceType === 'Renouvellement' && selectedVehicle) {
      ...
      const existingPolicyNumber = vehicle?.insuranceId?.policyNumber;

      setFormData(prev => ({
        ...prev,
        policyNumber: existingPolicyNumber || ''
      }));
    } else if (formData.insuranceType === 'Remplacement' || formData.insuranceType === 'Affaire Nouvelle') {
    ...
    return (
      <div className="p-4 sm:p-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">New Insurance</h1>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden p-6">
          <div className="text-center py-6">
            ...
            <p className="mt-1 text-sm text-gray-500 mb-4">
              You need to create a vehicle first before creating a Insurance.
            </p>
            <button
    ...
    <div className="p-4 sm:p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Create New Insurance</h1>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                required
                readOnly={formData.insuranceType === 'Renouvellement' && selectedVehicle?.insuranceId}
              />
            </div>
