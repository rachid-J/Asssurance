...
export function NewPolicyModal({ isOpen, onClose, client, onPolicyCreated }) {
  const [formData, setFormData] = useState({
    policyNumber: '',
    insuranceType: 'Fairnouvel',
    usage: '',
    comment: '',
    primeHT: '',
    primeTTC: '',
  ...
  const insuranceTypes = ['Fairnouvel', 'Auto', 'Habitation', 'Santé', 'Vie'];
  ...
  return (
    <PolicyModalBase 
      isOpen={isOpen} 
      onClose={onClose} 
      title={`New Policy for ${client?.name || ''}`}
    >
      {error && (
